      ...
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <div className="mt-1 p-2 bg-gray-50 rounded-[6px] border border-gray-200 capitalize">
          ...
          <div>
            ...
            <div className="mt-1 p-2 bg-gray-50 rounded-[6px] border border-gray-200">
          ...
          <div>
            ...
            <div className="mt-1 p-2 bg-gray-50 rounded-[6px] border border-gray-200">
              {studentData?.student?.dateOfBirth ? format(parseISO(studentData.student.dateOfBirth), "yyyy-MM-dd") : 'N/A'}
            </div>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">Gender</label>
            <div className="mt-1 p-2 bg-gray-50 capitalize rounded-[6px] border border-gray-200">
